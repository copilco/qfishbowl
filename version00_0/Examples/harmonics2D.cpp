...
int main()
{
  ...
  out0=fopen("hhg2D0.txt","w");
  out1=fopen("hhg2D1.txt","w");
  out2=fopen("hhg2D2.txt","w");
  out3=fopen("hhg2D3.txt","w");  
  out4=fopen("hhg2D4.txt","w");
  out5=fopen("hhg2D5.txt","w");
  out6=fopen("hhg2D6.txt","w");
  out7=fopen("hhg2D7.txt","w");
 ...
 /*************************************************************************************************/
  ...
  int snaper2=200;//int(0.125*period/abs(dt));
